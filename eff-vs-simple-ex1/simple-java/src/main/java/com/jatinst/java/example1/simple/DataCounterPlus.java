...
/**
 * Class that shows how a feature request such as printing out a different line if the
 * datacount is greater than a certain threshold can be added to the DataCounter.java class
 * 
...
public class DataCounterPlus {
	...
	public void printDataCount(Connection conn, String dbName) {
		...
		try {
			...
			if(result > THRESHOLD){
				System.out.println("We have more Trades than usual!");
			} else {
				System.out.println("We have the same number of Trades as always");
			}
